...
export default function Header() {
    ...
    useEffect(() => {
        ...
        setCurrentDate(`${dayName}. ${date} ${month} ${year}`);
    }, []);
                    ...
                    <div className="container px-0">
                        <div className="topbar-top d-flex justify-content-between flex-lg-wrap">
                            ...
                            <div className="top-link flex-lg-wrap">
                                <i className="fas fa-calendar-alt text-white border-end border-secondary pe-2 me-2"> <span className="text-body">{new Date().toLocaleDateString('en-US', { weekday: 'long', year: 'numeric', month: 'short', day: 'numeric' })}</span></i>
                    ...
                    <div className="container px-0">
                        <nav className="navbar navbar-light navbar-expand-xl">
                            <a onClick={() => navigate(ROUTES.Home)} className="navbar-brand mt-3">
                                <p className="text-primary display-6 mb-2" style={{ lineHeight: 0 }}>Captilance News</p>
                            </a>
                            ...
                            <div className="collapse navbar-collapse bg-light py-3" id="navbarCollapse">
                                <div className="navbar-nav mx-auto border-top">
                                    ...
                                    <div className="nav-item dropdown">
                                        ...
                                        <div className="dropdown-menu m-0 bg-secondary rounded-0 cursor-pointer">
                                    ...
                                    <a onClick={() => navigate(ROUTES.LiveNews)} className="nav-item nav-link cursor-pointer">Live News</a>
                                    <a onClick={() => navigate(ROUTES.Contact)} className="nav-item nav-link cursor-pointer">Contact Us</a>
                                    <a onClick={() => navigate(ROUTES.About)} className="nav-item nav-link cursor-pointer">About Us</a>
                                ...
                                <div className="d-flex flex-nowrap border-top pt-3 pt-xl-0">
                                    ...
                                    &nbsp;
                                    <a onClick={() => navigate(ROUTES.Wishlist)} className="btn-search btn border border-primary btn-md-square rounded-circle bg-white my-auto"><i className="fas fa-heart text-primary" /></a>
                                </div>
                            </div>
                        </nav>
                    </div>
