                        ...
                        <div className="row g-4">
                            <div className="col-lg-3">
                                <a href="#" className="d-flex flex-column flex-wrap">
                                    <p className="text-white mb-0 display-6">Capti News</p>
                                    <br />
                                    <small className="text-light" style={{ letterSpacing: 11, lineHeight: 0 }}>Newspaper</small>
                                </a>
                            </div>
                    ...
                    <div className="row g-5">
                        ...
                        <div className="col-lg-6 col-xl-3">
                            <div className="d-flex flex-column text-start footer-item-3">
                                ...
                                <a className="btn-link text-white" href><i className="fas fa-angle-right text-white me-2" /> Technology</a>
                                <a className="btn-link text-white" href><i className="fas fa-angle-right text-white me-2" /> Intertainment</a>
                            </div>
                        </div>
                        <div className="col-lg-6 col-xl-3">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                            <span className="text-light"><a href="#"><i className="fas fa-copyright text-light me-2" />Capti News</a>, All right reserved.</span>
                        </div>
