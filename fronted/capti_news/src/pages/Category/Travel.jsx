...
export default function Travel() {
    ...
    return (
        <div className="business-news-container">
            <h1 className="title">✈️ Travel News</h1>
            <input
                type="text"
            ...
            <marquee behavior="alternate" direction="right" className="ticker">
                <p>
                    Top 10 must-visit destinations for 2025 revealed! &nbsp;&nbsp;&nbsp;
                    Visa-free travel expanded for several countries. &nbsp;&nbsp;&nbsp;
                    Budget airlines announce massive holiday discounts. &nbsp;&nbsp;&nbsp;
                    Travel advisory issued for parts of Southeast Asia. &nbsp;&nbsp;&nbsp;
                    Cruise bookings hit a record high this fall. &nbsp;&nbsp;&nbsp;
                    Explore hidden gems: Underrated cities to visit this year!
                </p>
            </marquee>
