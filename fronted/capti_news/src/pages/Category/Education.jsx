...
export default function Education() {
    ...
    return (
        <div className="business-news-container">
            <h1 className="title">🎓 Education News</h1>
            <input
                type="text"
            ...
            <marquee behavior="alternate" direction="right" className="ticker">
                <p>
                    New academic year starts from September 15th – enroll now! &nbsp;&nbsp;&nbsp;
                    Free online coding bootcamp for students – register today! &nbsp;&nbsp;&nbsp;
                    National Scholarship Portal is now open for applications. &nbsp;&nbsp;&nbsp;
                    Join our webinar on effective study habits this Friday. &nbsp;&nbsp;&nbsp;
                    Access free e-books and resources on our library portal. &nbsp;&nbsp;&nbsp;
                    Career counseling sessions available for high school students.
                </p>
            </marquee>
