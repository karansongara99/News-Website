...
export default function Lifestyle() {
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            try {
                const response = await axios.get('http://localhost:5000/api/lifestyle');
    ...
    return (
        <div className="business-news-container">
            <h1 className="title">👜 Lifestyle News</h1>
            <input
                type="text"
            ...
            <marquee behavior="alternate" direction="right" className="ticker">
                <p>
                10-minute morning routines to boost your productivity. &nbsp;&nbsp;&nbsp;
        Discover the top travel destinations for 2025. &nbsp;&nbsp;&nbsp;
        Healthy eating made easy: simple recipes for busy lives. &nbsp;&nbsp;&nbsp;
        Home décor trends: Minimalism meets comfort. &nbsp;&nbsp;&nbsp;
        How to balance work and wellness in a digital world. &nbsp;&nbsp;&nbsp;
        Join our lifestyle podcast for weekly inspiration!
                </p>
            </marquee>
