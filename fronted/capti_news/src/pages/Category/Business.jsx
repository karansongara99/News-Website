...
export default function Business() {
    ...
    return (
        <div className="business-news-container">
            <h1 className="title">📈 Business News</h1>
            <input
                type="text"
            ...
            <marquee behavior="alternate" direction="right" className="ticker">
                <p>
                    Stock markets show positive trends ahead of Q4 reports. &nbsp;&nbsp;&nbsp;
                    New startup funding crosses $5 billion this quarter. &nbsp;&nbsp;&nbsp;
                    Remote work policies are reshaping corporate strategies. &nbsp;&nbsp;&nbsp;
                    Attend our business growth webinar this Thursday. &nbsp;&nbsp;&nbsp;
                    Global oil prices fall amid supply chain improvements. &nbsp;&nbsp;&nbsp;
                    Don't miss the Business Expo 2025 – Register now!
                </p>
            </marquee>
