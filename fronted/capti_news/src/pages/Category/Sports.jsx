    ...
    return (
        <div className="business-news-container">
            ...
            <marquee behavior="alternate" direction="right" className="ticker">
                <p>
                    Team India advances to the ICC World Cup semifinals! &nbsp;&nbsp;&nbsp;
                    Premier League: Manchester United wins 3–1 over Chelsea. &nbsp;&nbsp;&nbsp;
                    Serena Williams hints at a return to professional tennis. &nbsp;&nbsp;&nbsp;
                    Olympic qualifiers to begin next month in Tokyo. &nbsp;&nbsp;&nbsp;
                    NBA preseason games kick off this weekend. &nbsp;&nbsp;&nbsp;
                    Cristiano Ronaldo scores his 850th career goal!
                </p>
            </marquee>
